    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">@lang('text.ProductsForRepair')</h3>
            </div>
            @if(!($deleted ?? ''))
        ...
        <div class="card-body">
            <livewire:products.index :idx="$idx ?? ''"
                                     :productStatusId="(int)$productStatusId ?? 0"
                                     :categoryId="(int)$categoryId ?? 0"
                                     :problemTypeId="(int)$problemTypeId ?? 0"
