<div>
    @include('layout.partials.filters.problem-types')
        ...
        <table class="table table-bordered table-hover dataTable" id="kt_datatable">
            ...
            @foreach($problems ?? [] as $problem)
                <tr>
                    ...
                    <td>{{$problem->payout}}</td>
                    <td nowrap>
                        @if($deleted)
                            <button onclick="loading()" wire:click="restore({{$problem->id}})"
                        ...
                        @else
                            ...
                            @endcan
                            @can('delete', $problem)
                                <button onclick="loading()" wire:click="delete({{$problem->id}})" class="btn btn-sm btn-clean btn-icon"
