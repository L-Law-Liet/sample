<div>
    @include('layout.partials.filters.clients')
    <div class="table-responsive">
        <table class="table table-bordered table-hover dataTable" id="kt_datatable">
            ...
            label-light-{{($client->internal) ? 'success' : 'danger'}}">
                {{($client->internal) ? __('text.Internal') : __('text.External')}}
            </span>
                    </td>
                    <td nowrap>
                        @if($deleted)
                            <button onclick="loading()" wire:click="restore({{$client->id}})"
                        ...
                        @else
                            ...
                            @endcan
                            @can('delete', $client)
                                <button onclick="loading()" wire:click="delete({{$client->id}})" class="btn btn-sm btn-clean btn-icon"
