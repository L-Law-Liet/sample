...
@section('content')
    ...
    <div class="alert alert-custom alert-white alert-shadow fade show gutter-b" role="alert">
        <div class="alert-icon">
            <?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/Tools/Compass.svg",
                ...
                <div class="card-body">
                    ...
                    <div class="example mb-10">
                        ...
                        <div class="example-preview">
                            <?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/Communication/Address-card.svg",
                                "mr-5"); ?>
                            <?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/Communication/Mail-heart.svg",
                                "mr-5"); ?>
                            <?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/Design/Component.svg", "mr-5"); ?>
                            <?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/Design/Substract.svg", "mr-5"); ?>
                            <?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/General/Settings-2.svg"); ?>
                        </div>
                    </div>
                    <!--end::Example-->
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="example mb-10">
                        ...
                        <div class="example-preview">
                            ...
                            <?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/Design/Component.svg",
                                "svg-icon-warning mr-5"); ?>
                            <?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/Design/Substract.svg",
                                "svg-icon-dark mr-5"); ?>
                            <?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/General/Settings-2.svg",
                                "svg-icon-primary"); ?>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="example-preview">
                            <a href="#" class="btn btn-success font-weight-bold mr-2">
                                <?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/Communication/Address-card.svg"); ?> Button
                            </a>

                            <a href="#" class="btn btn-light-danger font-weight-bold mr-2">
                                <?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/Design/Component.svg"); ?> Button 2
                            </a>

                            <div class="dropdown dropdown-inline">
                                <a href="#" class="btn btn-light-primary font-weight-bold dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/General/Settings-2.svg"); ?> Dropdown
                                </a>
                                <div class="dropdown-menu dropdown-menu-md py-5" style="">
                                    <ul class="navi navi-hover">
                                        <li class="navi-item">
                                            <a class="navi-link" href="#">
                                                <span class="navi-icon"><?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/Communication/Address-card.svg",
                                        ...
                                        <li class="navi-item">
                                            <a class="navi-link" href="#">
                                                <span class="navi-icon"><?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/Communication/Mail-heart.svg",
                                        ...
                                        <li class="navi-item">
                                            <a class="navi-link" href="#">
                                                <span class="navi-icon"><?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/Design/Component.svg",
                                        ...
                                        <li class="navi-item">
                                            <a class="navi-link" href="#">
                                                <span class="navi-icon"><?php echo App\Classes\Theme\Metronic::getSVG("media/svg/icons/General/Settings-2.svg",
